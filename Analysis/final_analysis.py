...
COLOR_MAP = {
    ...
    ('baseline-walkerv0',        'world.Walker_v0')       : ("#000000", 'Baseline Walker'),
    ('baseline-BridgeWalker_v0', 'world.BridgeWalker_v0') : ("#000000", 'Baseline Bridge'),
    ('quadrantv0',               'world.Walker_v0')       : ("#FF0000", 'Quadrant Walker'),
    ('quadrantv0',               'world.BridgeWalker_v0') : ("#FF0000", 'Quadrant Bridge'),
}
...
def print_pair_plot(df:pd.DataFrame, minFit:float=0.8, logDir:str="."):
    """
...
if __name__=="__main__":
    ...
    #                      )
    # Hamming line figure
    # hammingGenerationalData = build_generational_hamming_data(df)
